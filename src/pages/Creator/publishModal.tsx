      ...
      <div id="publish-modal">
        {!data ? (
          <>
            ...
            <p>
              Kliknięcie <span className="text-indigo-700">Zakończ i opublikuj</span> spowoduje
              przesłanie ankiety do bazy danych. Aby <span className="text-red-500"> usunąć </span>
          ...
          <>
            ...
            <p>
              Kliknij <span className="text-indigo-700">Zakończ</span> aby wrócić do strony głównej.
            </p>
