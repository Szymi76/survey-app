import { ChevronDownIcon, ChevronUpIcon, PencilIcon, XMarkIcon } from "@heroicons/react/24/solid";
    ...
    <div className="container qn">
      <div className="qn-row">
        <div className="input-with-icon">
          <input type={"text"} value={survey.questions[index].label} onChange={setLabel} />
        ...
        <div className="flex">
          ...
          <XMarkIcon className="h-8 cursor-pointer hover:text-red-500" onClick={removeQn} />
        </div>
      </div>
      {toggled && (
        <>
